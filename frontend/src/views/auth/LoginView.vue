    ...
    <div class="max-w-md w-full">
      ...
      <div class="card">
        ...
        <div
          ...
          class="bg-red-50 text-red-600 px-4 py-3 rounded-lg mb-4"
        >
...
onMounted(() => {
  ...
  if (errorParam) {
    const errors = {
      ...
      callback_failed: 'Error en el callback de autenticación.',
      oauth_failed: 'Error en la autenticación con redes sociales.'
    }
    error.value = errors[errorParam] || 'Error de autenticación'
  }
})
