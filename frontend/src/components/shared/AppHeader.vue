<template>
  <!-- Mobile-First Header -->
  <header class="top-0 z-20 bg-gray-900 backdrop-blur-lg border-b border-gray-800">
      ...
      <div class="flex items-center gap-3">
        ...
        <div v-else class="relative" ref="userMenuRef">
          ...
          <button @click="toggleUserMenu"
            ...
            <!-- Avatar -->
            <div
              class="w-7 h-7 rounded-full bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center text-white text-sm font-bold overflow-hidden">
              <img v-if="authStore.user?.profilePicture" :src="authStore.user.profilePicture" :alt="authStore.user.name"
            ...
            <!-- Chevron -->
            <svg class="w-4 h-4 text-gray-400 transition-transform" :class="{ 'rotate-180': showUserMenu }" fill="none"
          ...
          <Transition enter-active-class="transition ease-out duration-100"
            ...
            <div v-if="showUserMenu"
              ...
              <div class="px-4 py-3 border-b border-gray-700">
                ...
                <span class="inline-block mt-1 px-2 py-0.5 text-xs font-medium rounded-full" :class="roleColorClass">
                  {{ roleLabel }}
                </span>
              </div>
              ...
              <div class="py-1">
                ...
                <router-link v-if="authStore.isExhibitor" to="/exhibitor" @click="closeUserMenu"
                  class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
