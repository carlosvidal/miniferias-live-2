          ...
          >
            ...
            <main class="flex-1 overflow-y-auto">
              ...
              <div v-else-if="error" class="flex flex-col items-center justify-center h-full p-4">
                ...
                <button @click="emit('close')" class="px-6 py-2 bg-[#ee2b8c] text-white rounded-full font-semibold hover:bg-pink-600 transition-colors">
                  Cerrar
                </button>
              </div>
              ...
              <div v-else-if="order" class="p-4 space-y-6">
                ...
                <div class="text-center py-6">
                  <div class="inline-flex items-center justify-center w-20 h-20 bg-green-100/90 dark:bg-green-900/40 backdrop-blur-sm rounded-full mb-4">
                ...
                <div class="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                  ...
                  <div class="space-y-4">
                    <!-- Yape -->
                    <div v-if="booth.yapeNumber" class="p-3 bg-purple-50/90 dark:bg-purple-900/30 backdrop-blur-sm rounded-lg border border-purple-200 dark:border-purple-800">
                    ...
                    <!-- Plin -->
                    <div v-if="booth.plinNumber" class="p-3 bg-blue-50/90 dark:bg-blue-900/30 backdrop-blur-sm rounded-lg border border-blue-200 dark:border-blue-800">
                      <div class="flex items-center gap-2 mb-2">
                    ...
                    <!-- Bank Transfer -->
                    <div v-if="booth.bankAccount || booth.cci" class="p-3 bg-gray-50/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-lg border border-gray-200 dark:border-gray-600">
                      <div class="flex items-center gap-2 mb-2">
                  ...
                  <div class="mt-4 p-3 bg-yellow-50/90 dark:bg-yellow-900/30 backdrop-blur-sm rounded-lg border border-yellow-200 dark:border-yellow-800">
